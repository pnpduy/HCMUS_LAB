# -*- coding: utf-8 -*-
"""19110290_THPTTT_Tuan5.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1vS_RKyLarAyeFPqtJCYlUzT-gOBvCL14
...
a = int(input('Nhập cấp của ma trận vuông A: '))
b = int(input('Nhập cấp của ma trận vuông B: '))

rowsA, colsA = (a, a)
A = [[random.randint(1,1000) for i in range(colsA)] for j in range(rowsA)]
A = np.array(A)

rowsB, colsB = (b, b)
B = [[random.randint(1,1000) for i in range(colsB)] for j in range(rowsB)] 
B = np.array(B)

print("Ma trận A: ",A, "\n\n", "Ma trận B: ",B)

# Nhân 2 ma trận A, B theo cách thông thường:
C = A.dot(B)
print(C)

"""## 2/ Dùng kỹ thuật $\textbf{Chia để trị}$ để nhân 2 ma trận A, B với độ phức tạp $O(n^{log7})$"""
...
def multiply_matrix_level_2(A, B):
    n = len(A)
...
def strassenR(A, B):
    ...
    if n <= 2:
        return multiply_matrix_level_2(A, B)
    else:
